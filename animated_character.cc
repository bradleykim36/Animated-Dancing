    ...
    const Matrix4& view_matrix, const Matrix4& proj_matrix)
{
    ...
    */
    ...
    if (bone_name == "lhipjoint" || bone_name == "rhipjoint") {
        quick_shapes_.DrawLineSegment(ctm, view_matrix, proj_matrix, Color(0, 0, 0), Point3(0, 0, 0), Point3(0, 0, 0) + skeleton_.BoneDirectionAndLength(bone_name), 0.01f);
        quick_shapes_.DrawSphere(ctm * Matrix4::RotationX(M_PI / 4) * Matrix4::Scale(Vector3(0.15, 0.3, 0.15)) * Matrix4::Translation(Vector3(0, -0.5, 0)), view_matrix, proj_matrix, Color(1, 1, 0));
    }
    ...
    if (bone_name == "upperback") {
        quick_shapes_.DrawLineSegment(ctm, view_matrix, proj_matrix, Color(0, 0, 0), Point3(0, 0, 0), Point3(0, 0, 0) + skeleton_.BoneDirectionAndLength(bone_name), 0.01f);
        quick_shapes_.DrawSphere(ctm * Matrix4::RotationX(M_PI / 3) * Matrix4::Scale(Vector3(0.1, 0.12, 0.1)) * Matrix4::Translation(Vector3(0, 0.4, 0)), view_matrix, proj_matrix, Color(1, 1, 0));
    }
    if (bone_name == "thorax") {
        quick_shapes_.DrawLineSegment(ctm, view_matrix, proj_matrix, Color(0, 0, 0), Point3(0, 0, 0), Point3(0, 0, 0) + skeleton_.BoneDirectionAndLength(bone_name), 0.01f);
        quick_shapes_.DrawSphere(ctm * Matrix4::RotationX(M_PI / 10) * Matrix4::Scale(Vector3(0.1, 0.12, 0.1)) * Matrix4::Translation(Vector3(0, 0.4, 0)), view_matrix, proj_matrix, Color(1, 1, 0));
    }
    if (bone_name == "lowerneck" || bone_name == "upperneck") {
        quick_shapes_.DrawLineSegment(ctm, view_matrix, proj_matrix, Color(0, 0, 0), Point3(0, 0, 0), Point3(0, 0, 0) + skeleton_.BoneDirectionAndLength(bone_name), 0.01f);
    }
    if (bone_name == "head") {
        quick_shapes_.DrawSphere(ctm * Matrix4::RotationX(-M_PI / 8) * Matrix4::Scale(Vector3(0.1, 0.2, 0.1)) * Matrix4::Translation(Vector3(0, 0.2, 0)), view_matrix, proj_matrix, Color(1, 1, 0));
        quick_shapes_.DrawSphere(ctm * Matrix4::Scale(Vector3(0.03, 0.03, 0.02)) * Matrix4::Translation(Vector3(-2, 4.6, 0)), view_matrix, proj_matrix, Color(0, 0, 0));
        quick_shapes_.DrawSphere(ctm * Matrix4::Scale(Vector3(0.03, 0.03, 0.02))  * Matrix4::Translation(Vector3(2, 4.6, 0)), view_matrix, proj_matrix, Color(0, 0, 0));
        quick_shapes_.DrawCone(ctm * Matrix4::RotationZ(M_PI / 6) * Matrix4::Scale(Vector3(0.01, 0.08, 0.01)) * Matrix4::Translation(Vector3(2.4, 3.2, -2.8)), view_matrix, proj_matrix, Color(0, 0, 0));
        quick_shapes_.DrawCone(ctm * Matrix4::Translation(Vector3(-0.12, 0.27, 0.1)) * Matrix4::RotationZ(M_PI / 2) * Matrix4::RotationX(M_PI / 2) * Matrix4::Scale(Vector3(0.01, 0.12, 0.01))* Matrix4::Translation(Vector3(0.12, -0.27, -0.1)), view_matrix, proj_matrix, Color(0, 0, 0));
        quick_shapes_.DrawCone(ctm * Matrix4::RotationZ(-M_PI / 6) * Matrix4::Scale(Vector3(0.01, 0.08, 0.01)) * Matrix4::Translation(Vector3(-2.4, 3.2, -2.8)), view_matrix, proj_matrix, Color(0, 0, 0));
        quick_shapes_.DrawCone(ctm * Matrix4::Translation(Vector3(0.12, 0.27, 0.1)) * Matrix4::RotationZ(M_PI / 2) * Matrix4::RotationX(M_PI / 2) * Matrix4::Scale(Vector3(0.01, 0.12, 0.01)) * Matrix4::Translation(Vector3(-0.12, -0.27, -0.1)), view_matrix, proj_matrix, Color(0, 0, 0));
        quick_shapes_.DrawSphere(ctm * Matrix4::Scale(Vector3(0.05, 0.03, 0.02)) * Matrix4::Translation(Vector3(0, -2, 5)), view_matrix, proj_matrix, Color(0, 0, 0));
    }
